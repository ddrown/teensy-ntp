...
// Wire-format NTP packet layout and protocol constants (RFC 5905).
// Deliberately has no lwIP dependency, unlike NTPServer.h (whose recv()
// signature needs struct pbuf/ip_addr_t) -- split out so NTPResponseFields.h
// can share the packet layout/constants without pulling lwIP headers into a
// file that has nothing to do with lwIP. See TODO.md, "Test coverage for
// NTPServer".
